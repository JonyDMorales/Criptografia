...
public class Key extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Key (16 bits): ");

        btnKey.setText("Submit");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtKey, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnKeyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeyActionPerformed
        ImagenAES aes = new ImagenAES();
        aes.Key(txtKey.getText());
